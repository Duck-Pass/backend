    ...
    return "DuckPass Account Verification", f"""
        ...
        <body>
            <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; background-color: #f8f8f8; padding: 2rem;">
                ...
                <a style="margin-top: 1rem; padding: 1rem; border-radius: 0.5rem; font-size: 1rem; text-decoration: none; background: #022837; color: white;" href="http://staging.duckpass.ch/verify/?token={token}">
                    Verify your email
                <a>
